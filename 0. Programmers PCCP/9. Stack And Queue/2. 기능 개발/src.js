 ...
 */
const canDeploy = (progress, speed, remainingDays) => progress + speed * remainingDays >= 100;
...
const solution = (progresses, speeds) => {
  ...
  for (let i = 0; i < progresses.length; i++) {
    ...
    while (i + 1 < progresses.length && canDeploy(progresses[i + 1], speeds[i + 1], waitingDays)) {
